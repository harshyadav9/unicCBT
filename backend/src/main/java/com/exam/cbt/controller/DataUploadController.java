...
public class DataUploadController {
	...
	ResponseEntity<String> importExamYearMasterData(@RequestParam("file") MultipartFile files)
			throws IOException {
	...
	ResponseEntity<String> importConfigData(@RequestParam("file") MultipartFile files)
			throws IOException {
	...
	ResponseEntity<String> importCandidateMasterData(@RequestParam("file") MultipartFile files)
			throws IOException {
